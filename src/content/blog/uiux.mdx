---
title: "Psicología detrás del ui/ux"
pubDate: 2023-06-29
intro: La psicología juega un papel fundamental en la experiencia del usuario (UX). La UX se trata de cómo las personas perciben, interactúan y se sienten al usar un producto, servicio o sistema. Aquí hay un poco más de contexto sobre la psicología detrás de la experiencia de usuario
tag: ui/ux
author: dannyveneno
...
<iframe
  width='464'
  height='464'
  src='https://www.youtube.com/embed/nnUslqgSEO0'
  title='Psicologia detras de UI/UX'
  frameborder='0'
