...
title: IA Generativa
pubDate: 2024-06-25
intro: La inteligencia artificial generativa (IA generativa) es una rama de la inteligencia artificial que se enfoca en la creación de contenido original a partir de datos existentes.
tag: ia
author: dannyveneno
image: ../../assets/iagen.webp
---

import { Image } from "astro:assets";
import iagen from "../../assets/iagen.jpg";
...
<iframe
  width='576'
  height='576'
  src='https://www.youtube.com/embed/hjj9Dr1qHAI'
  title='Sora Inteligencia Artificial Generativa / wooly mammoth'
  frameborder='0'
